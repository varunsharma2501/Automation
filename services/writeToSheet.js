...
const writeToSheet = async (data, sheetName) => {
  ...
  // const headers = ["name","companyUrl","contactDetails","isCompanyUrlValid","services","location"];
  const headers = ["name","companyUrl","contactDetails","description","ownerName","location"];
